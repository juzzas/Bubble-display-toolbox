...
PUBLIC _put_char_at_index
PUBLIC _flush_display_buffer
PUBLIC _clear_buffer


_put_char_at_index:
    pop bc  ; pop return address
    pop hl  ; pop arguments (h = pos, l = char)
    push bc
    ld a, l
    ld c, h
    call put_char_at_index
    ret

_flush_display_buffer:
    jp flush_display_buffer
...
defc DIGIT_SELECT_PORT = 00		
defc SEGMENT_PORT = 02

SECTION data_user

on_time:			defw $00e0
off_time:			defw $0020						; usually just use on_time
